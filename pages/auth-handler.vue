...
<script setup lang="ts">
    ...
    import { verifyPasswordResetCode, applyActionCode, confirmPasswordReset, Auth } from 'firebase/auth'
    ...
    const handleResetPassword = (actionCode: any, continueUrl: any, lang: any) => {
    ...
    const handleVerifyEmail = (actionCode: any, continueUrl: any, lang: any) => {
    ...
    const resetPassword = () => {
        ...
        confirmPasswordReset(auth, actionCode, reset_password.value).then((resp) => {
            loading.reset = false
            addToast({
