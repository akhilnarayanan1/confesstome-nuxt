<template>
    <div class="navbar bg-white/10 backdrop-blur-lg border-b border-white/20 sticky top-0 z-40">
        <div class="flex-none">
            <button class="btn btn-square btn-ghost text-white hover:bg-white/20 border-white/30">
        ...
        <div class="flex-none">
            <div class="dropdown dropdown-end">
                <div tabindex="0" role="button" class="btn btn-ghost text-white hover:bg-white/20 border-white/30">
